...
const HARDWARE = [
  ...
  },
  {
    ...
    name:        'Server Rack',
    icon:        '🗄️',
    desc:        'Enterprise server rack. Max 4 servers total.',
    computePS:   30,
    elecPS:      2,
    baseCost:    3000,
    costMult:    1.15,
  ...
  },
  {
    ...
    icon:        '🏭',
    desc:        'An entire data center floor. Max 4 servers total.',
    computePS:   250,
    elecPS:      15,
    baseCost:    40000,
    costMult:    1.18,
  ...
  },
  {
    ...
    icon:        '⚛️',
    desc:        'Quantum-accelerated compute. Max 4 servers total.',
    computePS:   2000,
    elecPS:      100,
    baseCost:    600000,
    costMult:    1.20,

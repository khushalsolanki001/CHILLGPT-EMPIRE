...
const HARDWARE = [

  {
    ...
    name:        'GPU Cluster',
    icon:        '🔋',
    desc:        '8× consumer GPUs networked together. Real throughput.',
    computePS:   5,
    elecPS:      0.4,
    baseCost:    400,
    costMult:    1.14,
  ...
  },
  {
    ...
    name:        'Server Rack',
    icon:        '🗄️',
    desc:        'Enterprise server rack. The garage is barely holding it.',
    computePS:   30,
    elecPS:      2,
    baseCost:    3000,
    costMult:    1.15,
  ...
  },
  {
    ...
    icon:        '🏭',
    desc:        'An entire data center floor. Corporate scale at last.',
    computePS:   250,
    elecPS:      15,
    baseCost:    40000,
    costMult:    1.18,
  ...
  },
  {
    ...
    icon:        '⚛️',
    desc:        'Quantum-accelerated compute. The future is now.',
    computePS:   2000,
    elecPS:      100,
    baseCost:    600000,
    costMult:    1.20,
